                ...
                >
                    <div style={{ marginBottom: 16, display: "flex", justifyContent: "center" }}>
                        <svg
                            ...
                            fill="none"
                            aria-hidden="true"
                            style={{ filter: "drop-shadow(0 0 12px rgba(0,245,255,0.45))" }}
                        >
                            <circle cx="30" cy="30" r="26" stroke="rgba(0,245,255,0.45)" strokeWidth="2" />
                            <path
                                d="M22 29h16M22 34h16M30 18v10"
                                stroke="#00f5ff"
                                strokeWidth="2.5"
                                strokeLinecap="round"
                            />
                            <path
                                d="M24 23a6 6 0 0 1 12 0"
                                stroke="#00f5ff"
                                strokeWidth="2.5"
                                strokeLinecap="round"
                            />
