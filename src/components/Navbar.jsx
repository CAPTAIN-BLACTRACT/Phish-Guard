            ...
            <div style={{ position: "relative", display: "flex", alignItems: "center", gap: 8 }}>
              ...
              >
                ...
                <div className="nav-dropdown" style={{
                  ...
                  zIndex: 9999, display: profileMenuOpen ? "block" : "none", animation: "fuA 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275) both",
                  ...
                  {EXTRA_LINKS.map(({ id, label, icon }) => (
                    <div
                      key={id}
                      onClick={() => { setProfileMenuOpen(false); setPage(id); }}
                  ...
                  <div
                    onClick={() => { setProfileMenuOpen(false); signOutUser(); }}
